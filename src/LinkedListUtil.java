...
public class LinkedListUtil {
	/**
	 * 
	 * @param first an ascending linked list
	 * @param second an ascending linked list
	 * @return a merged ascending linked list
	 */
    public static ListNode mergeAscendingSinglyLinkedList(ListNode first, ListNode second) {
     ...
     * @return a reversed linked list, please note that the input linked list will be changed.
     */
